...
geneset <- geneset[grep('_B_CELL|_T_CELL|NATURAL_KILLER|ANTIBODY|ANTIGEN|LYMPHOCYTE|IMMUNE|INTERFERON|TOLL|INNATE|ADAPTIVE', names(geneset))]
...
```{r, message=FALSE, warning=FALSE, fig.width=45, fig.height=30}
...
```{r, message=FALSE, warning=FALSE, fig.width=40, fig.height=30}
plot_list <- lapply(celltypes, function(ds){
